...
let () =
  describe "key" (fun {test; _} ->
      ...
      test "invalid prefix" (fun {expect; _} ->
          (expect.option
             (of_string
                "edpuvDqjL7aXdsXSiK5ChCMAfqaqmCFWCv7DaT3dK1egJt136WBiT6"))
            .toBeNone
            () ;
          (expect.option
             (of_string
      ...
      test "invalid checksum" (fun {expect; _} ->
          (expect.option
             (of_string
                "edpkvDqjL7aXdsXSiK5ChCMAfqaqmCFWCv7DaT3dK1egJt136WBiT5"))
            .toBeNone
            () ;
          (expect.option
             (of_string
      ...
      test "invalid size" (fun {expect; _} ->
          ...
          (expect.option
             (of_string
                "sppk7Cim2kYBWGoEQGezcg8LbHi99XxrAE5dh6DDUru26pT93V2c5U"))
            .toBeNone
            () ;
          (expect.option
             (of_string
                "p2pk67mCLE2iFivprKpjugLakXfahdq9VUqmiTho1fhtv9P3AeJoc7"))
            .toBeNone
            ()))
...
let () =
  describe "secret" (fun {test; _} ->
      ...
      test "invalid prefix" (fun {expect; _} ->
          (expect.option
             (of_string
                "edsa4bfbFdb4s2BdkW3ipfB23i9u82fgji6KT3oj2SCWTeHUthbSVd"))
            .toBeNone
            () ;
          (expect.option
             (of_string
                "spdk3LfH15rYByf7whY9YNAxS5ghpjzCr96jZ16Jt4pv2mnshf8Tcy"))
            .toBeNone
            () ;
          (expect.option
             (of_string
                "p3sk2s8WFJdvL6J9JxY7R3tWwMnaqJotbcTFgXg3pSVNPvrxKL1AkQ"))
            .toBeNone
            ()) ;
      test "invalid checksum" (fun {expect; _} ->
          (expect.option
             (of_string
                "edsk4bfbFdb4s2BdkW3ipfB23i9u82fgji6KT3oj2SCWTeHUthbSVb"))
            .toBeNone
            () ;
          (expect.option
             (of_string
                "spsk3LfH15dYByf7whY9YNAxS5ghpjzCr96jZ16Jt4pv2mnshf8Tcy"))
            .toBeNone
            () ;
          (expect.option
             (of_string
                "p2sk3s8WFJdvL6J9JxY7R3tWwMnaqJotbcTFgXg3pSVNPvrxKL1AkQ"))
            .toBeNone
            ()) ;
      test "invalid size" (fun {expect; _} ->
          (expect.option
