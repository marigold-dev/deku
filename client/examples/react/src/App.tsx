...
const App = () => {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      ...
      deku.getBalance("tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb", ticketer_value, "0x" + data_value)
        .then(setBalance)
        .catch(console.error)
    }, 1000);
    return () => {
  ...
  const transferExample = async () => {
    ...
    const operationHash = await deku.transferTo("tz1VSUr8wwNhLAzempoch5d6hLRiTh8Cjcjb", 10, ticketer_value, data_value);
  ...
  const withdrawExample = async () => {
    ...
    const operationHash = await deku.withdrawTo(ticketer_value, 10, ticketer_value, data_value);
  ...
  return (
    ...
    <>
      <input type="text" id="textfield1" placeholder="ticketer" defaultValue="KT1Bt9N4ZcPkWzbsG8caEV8keFe1Spkt4TLR" />
      <input type="text" id="textfield2" placeholder="data" defaultValue="050505030b" />
    </>
