...
void tree_sitter_PascaLigo_external_scanner_reset(void *p) {}
unsigned tree_sitter_PascaLigo_external_scanner_serialize(void *p, char *buffer) { return 0; }
void tree_sitter_PascaLigo_external_scanner_deserialize(void *p, const char *b, unsigned n) {}

bool tree_sitter_PascaLigo_external_scanner_scan(
    void *payload,
    TSLexer *lexer,
