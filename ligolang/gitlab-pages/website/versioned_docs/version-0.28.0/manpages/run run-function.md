...
**ligo run run-function** *SOURCE_FILE* *PARAMETER_EXPRESSION* \[*OPTION*\]\...

### DESCRIPTION

Deprecated, renamed to evaluate-call. Use evaluate-call instead. This sub-command runs a LIGO function on a given argument. The context is initialized from a source file where the function is implemented. The interpretation is done using Michelson's interpreter.
