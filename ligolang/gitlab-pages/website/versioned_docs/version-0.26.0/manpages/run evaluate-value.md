...
**ligo run evaluate-value** *SOURCE_FILE* \[*OPTION*\]\...

### DESCRIPTION

Deprecated, renamed to evaluate-expr. Use evaluate-expr instead. This sub-command evaluates a LIGO definition. The context is initialized from a source file where the definition is written. The interpretation is done using a Michelson interpreter.
