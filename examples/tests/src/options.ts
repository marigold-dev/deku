...
export const DEKU_RPC = option({
    ...
    env: "DEKU_RPC",
    description: "The url of the deku node, if not specified it will be randomly choosen",
    parser: string => {
...
export const TICKETER = option({
    ...
    description: "The address of an originated dummy ticket contract, by default it will use the already orignated contract on ghostnet.",
    parser: string => string,
...
export const SECRET_WITH_TEZ = option({
    ...
    parser: string => string,
    default: 'edskRubBsVKzfE3rH7GXWb71UewQXDYd2ZDzW8818RWL9mQbRop4V8rJwcjmFRgMApJ1m7ygWPWEum4VtK2VxLokWu7iJAiDM9'
});
