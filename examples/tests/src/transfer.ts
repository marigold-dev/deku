...
const run = async ({dekuRpc, secret1WithTickets, secret2WithTickets, ticketer, data}) => {
    ...
    const op = await sender.deku.transferTo(receiver.addr, 1, ticketer, data.slice(2)); // TODO: "0x..." is not working in the toolkit
