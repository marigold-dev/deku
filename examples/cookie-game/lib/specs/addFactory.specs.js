...
describe('cookieBaker.addFactory nominal cases', () => {
    test('addFactory only mint one factory, decrease cookie amount, increase factory cost, and increase factories CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + factoryCostBefore;
            const cookie_Baker = (0, state_1.addFactory)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.factories === factoriesBefore + 1n
