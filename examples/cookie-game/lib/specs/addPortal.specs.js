...
describe('cookieBaker.addPortal nominal cases', () => {
    test('addPortal only mint one Portal, decrease cookie amount, increase Portal cost, and increase Portals CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + portalCostBefore;
            const cookie_Baker = (0, state_1.addPortal)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.portals === portalsBefore + 1n
