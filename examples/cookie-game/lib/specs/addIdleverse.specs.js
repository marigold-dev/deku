...
describe('cookieBaker.addIdleverse nominal cases', () => {
    test('addIdleverse only mint one idleverse, decrease cookie amount, increase idleverse cost, and increase idleverses CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + idleverseCostBefore;
            const cookie_Baker = (0, state_1.addIdleverse)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.idleverses === idleversesBefore + 1n
