...
describe('cookieBaker.addTemple nominal cases', () => {
    test('addTemple only mint one temple, decrease cookie amount, increase temple cost, and increase temples CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + templeCostBefore;
            const cookie_Baker = (0, state_1.addTemple)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.temples === templesBefore + 1n
