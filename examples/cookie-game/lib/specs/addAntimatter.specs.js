...
describe('cookieBaker.addAntimatter nominal cases', () => {
    test('addAntimatter only mint one Antimatter, decrease cookie amount, increase Antimatter cost, and increase Antimatters CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            const cookie_Baker = (0, state_1.addAntimatter)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.antimatters === antimattersBefore + 1n
