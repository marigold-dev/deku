...
describe('cookieBaker.addWizard nominal cases', () => {
    test('addWizard only mint one Wizard, decrease cookie amount, increase Wizard cost, and increase Wizards CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + wizardCostBefore;
            const cookie_Baker = (0, state_1.addWizard)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.wizards === wizardsBefore + 1n
