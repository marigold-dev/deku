...
describe('cookieBaker.addAlchemy nominal cases', () => {
    test('addAlchemy only mint one Alchemy, decrease cookie amount, increase Alchemy cost, and increase Alchemies CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + alchemyCostBefore;
            const cookie_Baker = (0, state_1.addAlchemy)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.alchemies === alchemiesBefore + 1n
