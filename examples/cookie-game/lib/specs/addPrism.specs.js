...
describe('cookieBaker.addPrism nominal cases', () => {
    test('addPrism only mint one Prism, decrease cookie amount, increase Prism cost, and increase Prisms CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + prismCostBefore;
            const cookie_Baker = (0, state_1.addPrism)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.prisms === prismsBefore + 1n
