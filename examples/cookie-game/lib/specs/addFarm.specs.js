...
describe('cookieBaker.addFarm nominal cases', () => {
    test('addFarm only mint one farm, decrease cookie amount, increase farm cost, and increase farms CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + farmCostBefore;
            const cookie_Baker = (0, state_1.addFarm)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                && cookie_Baker.cursors === cursorsBefore
                && cookie_Baker.grandmas === grandmasBefore
                && cookie_Baker.farms === farmsBefore + 1n
