...
describe('cookieBaker.addGrandma nominal cases', () => {
    test('addGrandma only mint one grandma, decrease cookie amount, increase grandma cost, and increase grandmas CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            return (cookie_Baker.cookies === cookiesBefore
                && cookie_Baker.grandmas === grandmasBefore + 1n
