...
describe('cookieBaker.addShipment nominal cases', () => {
    test('addShipment only mint one Shipment, decrease cookie amount, increase Shipment cost, and increase Shipments CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + shipmentCostBefore;
            const cookie_Baker = (0, state_1.addShipment)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.shipments === shipmentsBefore + 1n
