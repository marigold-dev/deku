...
describe('cookieBaker.add_XXX successful', function () {
    test('addCursor only mint one cursor, decrease cookie amount, increase cursor cost, and increase cursors CPS', function () {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), function (cookieBaker) {
            var cookiesBefore = cookieBaker.cookies;
            ...
            var cursors = cookie_Baker.cursors === cursorsBefore + 1;
            var cost = cookie_Baker.cursorCost >= cursorCostBefore;
            var cps = cookie_Baker.cursorCps > cursorCpsBefore;
            console.log("Cursors: " + cursors);
            console.log("cost: " + cost);
            console.log("cps: " + cps);
            console.log("les trois: " + (cursors && cost && cps));
            return (cursors && cost && cps
