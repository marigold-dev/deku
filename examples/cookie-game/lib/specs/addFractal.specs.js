...
describe('cookieBaker.addFractal nominal cases', () => {
    test('addFractal only mint one fractal, decrease cookie amount, increase fractal cost, and increase fractals CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + fractalCostBefore;
            const cookie_Baker = (0, state_1.addFractal)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.fractals === fractalsBefore + 1n
