...
describe('cookieBaker.addMine nominal cases', () => {
    test('addMine only mint one mine, decrease cookie amount, increase mine cost, and increase mines CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.mines === minesBefore + 1n
