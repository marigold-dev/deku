...
describe('cookieBaker.addJavaScript nominal cases', () => {
    test('addJavaScript only mint one javaScript, decrease cookie amount, increase javaScript cost, and increase javaScripts CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.javaScripts === javascriptsBefore + 1n
