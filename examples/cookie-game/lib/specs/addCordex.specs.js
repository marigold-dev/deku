...
describe('cookieBaker.addCordex nominal cases', () => {
    test('addCordex only mint one cordex, decrease cookie amount, increase cordex cost, and increase cordexs CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + cordexCostBefore;
            const cookie_Baker = (0, state_1.addCordex)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.cordexs === cordexsBefore + 1n
    ...
    test('Cannot mint cordex if not enough cookie', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            const cursorsBefore = cookieBaker.cursors;
            const grandmasBefore = cookieBaker.grandmas;
            const farmsBefore = cookieBaker.farms;
