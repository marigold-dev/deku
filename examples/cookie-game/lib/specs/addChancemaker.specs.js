...
describe('cookieBaker.addChanceMaker nominal cases', () => {
    test('addChanceMaker only mint one ChanceMaker, decrease cookie amount, increase ChanceMaker cost, and increase ChanceMakers CPS', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            ...
            cookieBaker.cookies = cookiesBefore + chanceMakerCostBefore;
            const cookie_Baker = (0, state_1.addChanceMaker)(cookieBaker);
            return (cookie_Baker.cookies === cookiesBefore
                ...
                && cookie_Baker.chanceMakers === chancemakersBefore + 1n
    ...
    test('Cannot mint ChanceMaker if not enough cookie', () => {
        fc.assert(fc.property((0, generators_1.cookieBakerArbitrary)(), cookieBaker => {
            const cursorsBefore = cookieBaker.cursors;
            const grandmasBefore = cookieBaker.grandmas;
            const farmsBefore = cookieBaker.farms;
