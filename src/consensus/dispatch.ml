...
let rec dispatch effect step state =
  ...
  | Check_bootstrap_signal bootstrap_signal ->
    check_bootstrap_signal ~bootstrap_signal effect state
...
and check_bootstrap_signal ~bootstrap_signal effect state =
  let state, step = Steps.check_bootstrap_signal bootstrap_signal state in
  dispatch effect step state
