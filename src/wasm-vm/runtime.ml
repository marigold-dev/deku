  ...
  Result.try_with (fun () ->
      ...
      let[@warning "-8"] Wasm.
        ...
        Wasm.Eval.invoke gas entrypoint
          [ Value.i32 (Int64.to_int32_exn storage_size) ]
      in
      let op_size =
        Bytes.get_int32_le
