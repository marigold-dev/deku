...
type t = {signature : Signature.t; public_key : Wallet.t; address : Key_hash.t}
[@@deriving ord]
...
let to_yojson, of_yojson =
  let module Serialized_data = struct
    type t = {signature : Signature.t; public_key : Wallet.t}
    [@@deriving yojson]
  end in
  let to_yojson t =
...
struct
  ...
  type t = {value : value; signature : signature}
