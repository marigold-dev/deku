  ...
  struct
    ...
    include
      (Encoding_helpers.Make_b58)(struct
                                    ...
                                    let size = 32
                                    let prefix =
                                      Base58.Prefix.ed25519_public_key
                                    let to_raw t =
                                      Cstruct.to_string
                                        (Ed25519.pub_to_cstruct t)
                                    let of_raw string =
  ...
  struct
    ...
    include
      (Encoding_helpers.Make_b58)(struct
                                    ...
                                    let prefix =
                                      Base58.Prefix.ed25519_public_key_hash
  ...
  struct
    ...
    include
      (Encoding_helpers.Make_b58)(struct
                                    ...
                                    let size = 64
                                    let prefix =
                                      Base58.Prefix.ed25519_signature
                                    let to_raw = Fun.id
                                    let of_raw string =
...
let verify public signature hash =
  verify ~key:public ~msg:(Cstruct.of_string (BLAKE2B.to_raw_string hash))
