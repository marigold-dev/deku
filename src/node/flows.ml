...
(***************************************************************************)
(* Added block to the pool - snapshot *)
...
(***************************************************************************)
(* Received: Tezos operation, user operation, consensus operation *)
