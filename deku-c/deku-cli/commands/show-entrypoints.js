...
function main(apiUri, contractAddress, _a) {
    var verbose = _a.verbose;
    return __awaiter(this, void 0, void 0, function () {
        var deku, contract, entrypoints;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    deku = new deku_c_toolkit_1.DekuCClient({ dekuRpc: apiUri });
                    contract = deku.contract(contractAddress);
                    return [4 /*yield*/, contract.getEntrypoints()];
                case 1:
                    entrypoints = _b.sent();
