...
let as_num = function Num n -> n | _ -> failwith "as_num"
let as_vec = function Vec i -> i | _ -> failwith "as_vec"
let as_ref = function Ref r -> r | _ -> failwith "as_ref"
...
let type_of_vec = function V128 _ -> V128Type
...
let eq_ref' =
  ref (fun r1 r2 ->
      match (r1, r2) with NullRef _, NullRef _ -> true | _, _ -> false)
...
let default_vec = function V128Type -> V128 V128.zero
let default_ref = function t -> NullRef t
...
let string_of_vec = function V128 v -> V128.to_string v
