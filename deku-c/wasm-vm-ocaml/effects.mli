...
type _ Effect.t +=
  ...
  | Indirect_call : (int32 -> Wasm.Values.value list -> int64) Effect.t
  | Indirect_call_unit : (int32 -> Wasm.Values.value list -> unit) Effect.t
...
val call_indirect : unit -> int32 -> Wasm.Values.value list -> int64
val call_indirect_unit : unit -> int32 -> Wasm.Values.value list -> unit
