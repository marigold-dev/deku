...
export DEKU_TEZOS_DISCOVERY_ADDRESS="$(tezos-client --endpoint $DEKU_TEZOS_RPC_NODE show known contract discovery | grep KT1 | tr -d '\r')"
...
# TODO check the deposit succeeded?
# TODO: maybe randomize the node to which we're asking the withdraw as well
echo "*** Withdraw 1 ***"
