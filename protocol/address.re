...
let key_to_ed25519 =
  fun
  | Tz1_pk(ed25519_key) => ed25519_key;
...
type t =
  | Tz1(Ed25519.pub_); // TODO: is okay to have this public
let of_ed25519 = ed25519_pub => Tz1(ed25519_pub);
let to_ed25519 =
  fun
  | Tz1(ed25519_pub) => ed25519_pub;
...
let of_key =
  fun
  | Tz1_pk(k) => k |> Ed25519.pub_of_priv |> of_ed25519;
...
let genesis_address =
  switch (genesis_key) {
  | Tz1_pk(genesis_key) => genesis_key |> Ed25519.pub_of_priv |> of_ed25519
  };
